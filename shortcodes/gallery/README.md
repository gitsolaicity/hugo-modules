...
use this new version instead <https://github.com/gitsolaicity/hugo-modules/tree/master/gallery-slider>
...
```toml
[[imports]]
path = "github.com/gitsolaicity/hugo-modules/shortcodes/gallery"
```
