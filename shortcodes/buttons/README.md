...
use this new version instead <https://github.com/gitsolaicity/hugo-modules/tree/master/shortcodes/button>
...
```toml
[[imports]]
path = "github.com/gitsolaicity/hugo-modules/shortcodes/buttons"
```
